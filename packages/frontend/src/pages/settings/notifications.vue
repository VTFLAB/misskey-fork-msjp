...
const nonConfigurableNotificationTypes = ['note', 'roleAssigned', 'followRequestAccepted', 'test', 'exportCompleted', 'updateInfo'] as const satisfies (typeof notificationTypes[number])[];
