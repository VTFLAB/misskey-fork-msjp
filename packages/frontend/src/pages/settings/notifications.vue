...
const nonConfigurableNotificationTypes = ['note', 'roleAssigned', 'followRequestAccepted', 'test', 'exportCompleted', 'updateInfo', 'earthquakeAlert'] as const satisfies (typeof notificationTypes[number])[];
...
const onlyOnOrOffNotificationTypes = ['app', 'achievementEarned', 'login', 'createToken', 'scheduledNotePosted', 'scheduledNotePostFailed', 'twitchLiveStreamStarted'] as const satisfies (typeof notificationTypes[number])[];
