...
<div :class="$style.root">
	...
	<div v-if="!narrow && !isRoot && remoteGuestSession == null && !pageMetadata?.immersive" :class="$style.side">
	...
	<div :class="$style.main">
		<div v-if="narrow && !isRoot && remoteGuestSession == null && !pageMetadata?.immersive" :class="$style.header">
