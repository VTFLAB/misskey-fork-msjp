...
const $twitchStreamsRepository: Provider = {
	provide: DI.twitchStreamsRepository,
	useFactory: (db: DataSource) => db.getRepository(MiTwitchStream).extend(miRepository as MiRepository<MiTwitchStream>),
	inject: [DI.db],
};
