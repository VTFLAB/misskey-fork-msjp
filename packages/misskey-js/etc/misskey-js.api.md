...
// @public (undocumented)
type AdminFeedbackListRequest = operations['admin___feedback___list']['requestBody']['content']['application/json'];

// @public (undocumented)
type AdminFeedbackListResponse = operations['admin___feedback___list']['responses']['200']['content']['application/json'];

// @public (undocumented)
type AdminFeedbackUpdateRequest = operations['admin___feedback___update']['requestBody']['content']['application/json'];

// @public (undocumented)
type AdminFeedbackUpdateResponse = operations['admin___feedback___update']['responses']['200']['content']['application/json'];
...
// @public (undocumented)
type AdminUpdateInfoCreateRequest = operations['admin___update-info___create']['requestBody']['content']['application/json'];

// @public (undocumented)
type AdminUpdateInfoCreateResponse = operations['admin___update-info___create']['responses']['200']['content']['application/json'];

// @public (undocumented)
type AdminUpdateInfoDeleteRequest = operations['admin___update-info___delete']['requestBody']['content']['application/json'];

// @public (undocumented)
type AdminUpdateInfoListRequest = operations['admin___update-info___list']['requestBody']['content']['application/json'];

// @public (undocumented)
type AdminUpdateInfoListResponse = operations['admin___update-info___list']['responses']['200']['content']['application/json'];

// @public (undocumented)
type AdminUpdateInfoUpdateRequest = operations['admin___update-info___update']['requestBody']['content']['application/json'];
...
// @public (undocumented)
export const notificationTypes: readonly ["note", "follow", "mention", "reply", "renote", "quote", "reaction", "pollEnded", "scheduledNotePosted", "scheduledNotePostFailed", "receiveFollowRequest", "followRequestAccepted", "app", "roleAssigned", "chatRoomInvitationReceived", "achievementEarned", "exportCompleted", "test", "login", "createToken", "updateInfo", "earthquakeAlert", "twitchLiveStreamStarted", "googleAuthExpired"];
