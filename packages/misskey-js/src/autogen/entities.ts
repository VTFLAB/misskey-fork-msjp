...
export type AdminFeedbackListRequest = operations['admin___feedback___list']['requestBody']['content']['application/json'];
export type AdminFeedbackListResponse = operations['admin___feedback___list']['responses']['200']['content']['application/json'];
export type AdminFeedbackUpdateRequest = operations['admin___feedback___update']['requestBody']['content']['application/json'];
export type AdminFeedbackUpdateResponse = operations['admin___feedback___update']['responses']['200']['content']['application/json'];
...
export type AdminUpdateInfoCreateRequest = operations['admin___update-info___create']['requestBody']['content']['application/json'];
export type AdminUpdateInfoCreateResponse = operations['admin___update-info___create']['responses']['200']['content']['application/json'];
export type AdminUpdateInfoDeleteRequest = operations['admin___update-info___delete']['requestBody']['content']['application/json'];
export type AdminUpdateInfoListRequest = operations['admin___update-info___list']['requestBody']['content']['application/json'];
export type AdminUpdateInfoListResponse = operations['admin___update-info___list']['responses']['200']['content']['application/json'];
export type AdminUpdateInfoUpdateRequest = operations['admin___update-info___update']['requestBody']['content']['application/json'];
...
export type AtprotoBackfillRequest = operations['atproto___backfill']['requestBody']['content']['application/json'];
export type AtprotoBackfillResponse = operations['atproto___backfill']['responses']['200']['content']['application/json'];
export type AtprotoFollowRequest = operations['atproto___follow']['requestBody']['content']['application/json'];
export type AtprotoFollowResponse = operations['atproto___follow']['responses']['200']['content']['application/json'];
export type AtprotoSearchRequest = operations['atproto___search']['requestBody']['content']['application/json'];
export type AtprotoSearchResponse = operations['atproto___search']['responses']['200']['content']['application/json'];
export type AtprotoUnfollowRequest = operations['atproto___unfollow']['requestBody']['content']['application/json'];
export type AtprotoUnfollowResponse = operations['atproto___unfollow']['responses']['200']['content']['application/json'];
...
export type FeedbackCreateRequest = operations['feedback___create']['requestBody']['content']['application/json'];
export type FeedbackCreateResponse = operations['feedback___create']['responses']['200']['content']['application/json'];
export type FeedbackListRequest = operations['feedback___list']['requestBody']['content']['application/json'];
export type FeedbackListResponse = operations['feedback___list']['responses']['200']['content']['application/json'];
export type FeedbackListLocalRequest = operations['feedback___list-local']['requestBody']['content']['application/json'];
export type FeedbackListLocalResponse = operations['feedback___list-local']['responses']['200']['content']['application/json'];
export type FeedbackUpdateStatusLocalRequest = operations['feedback___update-status-local']['requestBody']['content']['application/json'];
export type FeedbackUpdateStatusLocalResponse = operations['feedback___update-status-local']['responses']['200']['content']['application/json'];
...
export type GoogleDriveRecordingStatusResponse = operations['google-drive___recording-status']['responses']['200']['content']['application/json'];
export type GoogleDriveUnlinkRequest = operations['google-drive___unlink']['requestBody']['content']['application/json'];
...
export type LiveChannelsCreateResponse = operations['live-channels___create']['responses']['200']['content']['application/json'];
export type LiveChannelsListRequest = operations['live-channels___list']['requestBody']['content']['application/json'];
export type LiveChannelsListResponse = operations['live-channels___list']['responses']['200']['content']['application/json'];
export type LiveChannelsMyResponse = operations['live-channels___my']['responses']['200']['content']['application/json'];
export type LiveChannelsRegenerateKeyResponse = operations['live-channels___regenerate-key']['responses']['200']['content']['application/json'];
export type LiveChannelsShowRequest = operations['live-channels___show']['requestBody']['content']['application/json'];
export type LiveChannelsShowResponse = operations['live-channels___show']['responses']['200']['content']['application/json'];
export type LiveChannelsUpdateRequest = operations['live-channels___update']['requestBody']['content']['application/json'];
export type LiveChannelsUpdateResponse = operations['live-channels___update']['responses']['200']['content']['application/json'];
export type LiveChannelsVerifyViewPasswordRequest = operations['live-channels___verify-view-password']['requestBody']['content']['application/json'];
export type LiveChannelsVerifyViewPasswordResponse = operations['live-channels___verify-view-password']['responses']['200']['content']['application/json'];
...
export type RemoteGuestLoginStartRequest = operations['remote-guest___login___start']['requestBody']['content']['application/json'];
export type RemoteGuestLoginStartResponse = operations['remote-guest___login___start']['responses']['200']['content']['application/json'];
export type RemoteGuestSessionRevokeRequest = operations['remote-guest___session___revoke']['requestBody']['content']['application/json'];
export type RemoteGuestSessionRevokeResponse = operations['remote-guest___session___revoke']['responses']['200']['content']['application/json'];
export type RemoteGuestTwitchCommentsRequest = operations['remote-guest___twitch-comments']['requestBody']['content']['application/json'];
export type RemoteGuestTwitchCommentsResponse = operations['remote-guest___twitch-comments']['responses']['200']['content']['application/json'];
export type RemoteGuestTwitchCommentsCreateRequest = operations['remote-guest___twitch-comments___create']['requestBody']['content']['application/json'];
export type RemoteGuestTwitchCommentsCreateResponse = operations['remote-guest___twitch-comments___create']['responses']['200']['content']['application/json'];
...
export type TwitchStreamsArchiveHistoryRequest = operations['twitch___streams___archive-history']['requestBody']['content']['application/json'];
export type TwitchStreamsArchiveHistoryResponse = operations['twitch___streams___archive-history']['responses']['200']['content']['application/json'];
...
export type TwitchStreamsBlocksDeleteRequest = operations['twitch___streams___blocks___delete']['requestBody']['content']['application/json'];
export type TwitchStreamsBlocksListRequest = operations['twitch___streams___blocks___list']['requestBody']['content']['application/json'];
export type TwitchStreamsBlocksListResponse = operations['twitch___streams___blocks___list']['responses']['200']['content']['application/json'];
export type TwitchStreamsCancelYoutubeUploadRequest = operations['twitch___streams___cancel-youtube-upload']['requestBody']['content']['application/json'];
export type TwitchStreamsCancelYoutubeUploadResponse = operations['twitch___streams___cancel-youtube-upload']['responses']['200']['content']['application/json'];
export type TwitchStreamsCommentsRequest = operations['twitch___streams___comments']['requestBody']['content']['application/json'];
export type TwitchStreamsCommentsResponse = operations['twitch___streams___comments']['responses']['200']['content']['application/json'];
export type TwitchStreamsCommentsCreateRequest = operations['twitch___streams___comments___create']['requestBody']['content']['application/json'];
export type TwitchStreamsCommentsCreateResponse = operations['twitch___streams___comments___create']['responses']['200']['content']['application/json'];
export type TwitchStreamsPreviewResponse = operations['twitch___streams___preview']['responses']['200']['content']['application/json'];
export type TwitchStreamsRetryDriveUploadRequest = operations['twitch___streams___retry-drive-upload']['requestBody']['content']['application/json'];
export type TwitchStreamsRetryDriveUploadResponse = operations['twitch___streams___retry-drive-upload']['responses']['200']['content']['application/json'];
export type TwitchStreamsShowRequest = operations['twitch___streams___show']['requestBody']['content']['application/json'];
export type TwitchStreamsShowResponse = operations['twitch___streams___show']['responses']['200']['content']['application/json'];
export type TwitchStreamsUnpublishArchiveRequest = operations['twitch___streams___unpublish-archive']['requestBody']['content']['application/json'];
export type TwitchStreamsUnpublishArchiveResponse = operations['twitch___streams___unpublish-archive']['responses']['200']['content']['application/json'];
export type TwitchStreamsUpdateArchiveSettingsRequest = operations['twitch___streams___update-archive-settings']['requestBody']['content']['application/json'];
export type TwitchStreamsUpdateArchiveSettingsResponse = operations['twitch___streams___update-archive-settings']['responses']['200']['content']['application/json'];
export type TwitchStreamsVerifyArchiveViewPasswordRequest = operations['twitch___streams___verify-archive-view-password']['requestBody']['content']['application/json'];
export type TwitchStreamsVerifyArchiveViewPasswordResponse = operations['twitch___streams___verify-archive-view-password']['responses']['200']['content']['application/json'];
export type TwitchSubtitlePublishRequest = operations['twitch___subtitle___publish']['requestBody']['content']['application/json'];
export type TwitchSubtitlePublishResponse = operations['twitch___subtitle___publish']['responses']['200']['content']['application/json'];
export type TwitchUpdateSettingsRequest = operations['twitch___update-settings']['requestBody']['content']['application/json'];
export type TwitchUpdateSettingsResponse = operations['twitch___update-settings']['responses']['200']['content']['application/json'];
export type UpdateInfoCreateLocalRequest = operations['update-info___create-local']['requestBody']['content']['application/json'];
export type UpdateInfoCreateLocalResponse = operations['update-info___create-local']['responses']['200']['content']['application/json'];
...
export type UpdateInfosRequest = operations['update-infos']['requestBody']['content']['application/json'];
export type UpdateInfosResponse = operations['update-infos']['responses']['200']['content']['application/json'];
