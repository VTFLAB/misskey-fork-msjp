...
declare module '../api.js' {
  export interface APIClient {
     ...
     * No description provided.
     * 
     * **Credential required**: *Yes* / **Permission**: *read:admin:feedback*
     */
    request<E extends 'admin/feedback/list', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * No description provided.
     * 
     * **Credential required**: *Yes* / **Permission**: *write:admin:feedback*
     */
    request<E extends 'admin/feedback/update', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *No*
     */
    request<E extends 'feedback/list-local', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *No*
     */
    request<E extends 'feedback/update-status-local', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *No*
     */
    request<E extends 'update-info/create-local', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
